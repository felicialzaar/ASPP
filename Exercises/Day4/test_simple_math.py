...
@pytest.mark.parametrize("x, a0, a1, expected",
    [(np.linspace(0, 1, 10), 2, 1, np.ones(len(np.linspace(0, 1, 10)))*2 + np.linspace(0, 1, 10)),
    (np.linspace(3, 10, 10), 0, 4, np.linspace(3, 10, 10))])
...
@pytest.mark.parametrize("x, a0, a1, a2, expected",
    [(np.linspace(0, 1, 10), 2, 1, 3,
    np.ones(len(np.linspace(0, 1, 10))) * 2
    + np.linspace(0, 1, 10)
    + 3 * np.linspace(0, 1, 10)**2),
    (np.linspace(3, 10, 10), 0, 4, 5, np.linspace(3, 10, 10)
    + 5 * np.linspace(3, 10, 10)**2)])
